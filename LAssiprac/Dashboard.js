...
<TextInput style={{backgroundColor:'lightgrey', marginBottom:10, width:160, height:30}}
     ...
     <View style={{flex:0.10, alignItems:'center',justifyContent:'center'}}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('Fetch')} style={{width:100, height:40, backgroundColor:'green', alignItems:'center',justifyContent:'center'}}>
          <Text style={{fontSize:20, color:'white'}}>Fetch</Text>
        </TouchableOpacity>
     </View>
